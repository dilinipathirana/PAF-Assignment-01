                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse nav-right">
                        <ul class="nav navbar-nav navbar-left cl-effect-15">
                            ...
                            <li>
                                <a href="HomeSystemuser.jsp">Home</a>
                            </li>
                            <!--  <li>
         ...
         <div class="login-form section text-center"  >
            <div class="container" >
                ...
                <div id="loginbox" style="margin-top:30px;" class="mainbox  loginbox">
                   <div style="padding:10px"class="panel panel-info"> 
...
%>
                     <div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div>
                            ...
                            <tr>
                            <th class="row1" width=150>    Full   Name    </th>   
                            <th class="row1"width=150> Permanent  Address </th>
                            <th class="row1">  Mobile  Number  </th>
                            <th class="row1"width=250>    Interested   Areas     </th>
                            </tr>
                      <%
try{ 
connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
statement=connection.createStatement();
String sql ="SELECT Full_Name,PAddress,Mobile,Interests FROM Customer";
...
%>           
                            ...
                            <tr><td class="row1"><%=resultSet.getString("Full_Name") %> </td>
                            	<td class="row1"><%=resultSet.getString("PAddress") %></td>
                            	<td class="row1"><%=resultSet.getString("Mobile") %></td>
                            	<td class="row1"><%=resultSet.getString("Interests") %></td>
                        ...
                        <div class="panel-body">
                            <form id="signupform" class="form-horizontal" action="#" method="post">
                                ...
                                <!--  <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" class="form-control" name="Date Of Birth" placeholder="yyyy/mm/dd" required="">
                                    </div>-->
                                </div>
                                <!--  <div class="form-group">
