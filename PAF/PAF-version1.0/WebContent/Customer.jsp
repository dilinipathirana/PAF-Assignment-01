...
String sql ="SELECT Full_Name,DOB,PAddress,CAddress,Mobile,HomePhone,Interests FROM Customer where Username='"+uname+"'";
...
%> 
                            ...
                            <form id="signupform" class="form-horizontal" action="#" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" class="form-control" name="fullname" value="<%=resultSet.getString("Full_Name") %>" placeholder="" required="">
                                    </div>
                                </div>
                               <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">Date Of Birth</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" class="form-control" name="Date Of Birth" value="<%=resultSet.getString("DOB") %>" placeholder="" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">Permenant Address</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" class="form-control" name="Permenant Address" value="<%=resultSet.getString("PAddress") %>"placeholder="" required="">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">Current Address</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" class="form-control" name="Current Address" value="<%=resultSet.getString("CAddress") %>"placeholder="" required="">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">Mobile Number</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" class="form-control" name="Mobile Number" value="<%=resultSet.getString("Mobile") %>" placeholder="+" required="">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">Home Telephone Number</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" class="form-control" name="Home Telephone Number" value="<%=resultSet.getString("HomePhone") %>" placeholder="" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 col-sm-3 col-xs-3 control-label">Interest</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" class="form-control" name="Interest" value="<%=resultSet.getString("Interests") %>"placeholder="" required="">
                                    </div>
                                </div>
                                <!--
                                <div class="form-group">
